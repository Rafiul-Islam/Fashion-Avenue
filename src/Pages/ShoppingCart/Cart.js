                ...
                <div className="col-md-4 mt-5 text-left">
                    <div className='alert alert-primary text-dark'>
                        ...
                        <div className="form-group mb-2">
                            <input type="number" className="form-control" id="coupon"
                                   placeholder="ENTER COUPON CODE"/>
                        </div>
                        <table className="table">
                            <tbody>
                            <tr>
                                <th scope="row" className='text-uppercase'>subtotal</th>
                                <td><strong>$</strong>
                                    {
                                        cartItems.reduce((a, c) => a + c.price * c.count, 0)
                                    }
                            ...
                            <tr>
                                <th scope="row" className='text-uppercase'>shipping</th>
                                <td>FREE</td>
                            </tr>
                            <tr>
                                <th scope="row" className='text-uppercase'>taxes</th>
